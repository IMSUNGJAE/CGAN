...
parser = argparse.ArgumentParser(description='Implementation of GAN')

# model hyper-parameters
parser.add_argument('--image_size', type=int, default=16)
parser.add_argument('--z_dim', type=int, default=16) # Must be same as Train
...
def main():
    ...
    # Sample the images
    noise = to_variable(torch.randn(args.sample_size, args.z_dim)) # test 데이터 있는 경로
